...
bots = [odds_bot, bluff_bot, chicken_bot, hardcore_ai_bot, knockout_bot, random_bot, never_bluff_bot]
#bots = [odds_bot,odds_bot,odds_bot,odds_bot,odds_bot,odds_bot,odds_bot,odds_bot]
